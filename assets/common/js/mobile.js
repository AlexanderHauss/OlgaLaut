...
module.exports = MinimalClass.extend({
	...
	resize: function () {
		...
		if (window.innerWidth < 570 && location.search !== "?device=desktop") {
...
},{"../public/BarkliIndexLoader":12,"../public/BarkliLoader":13,"../public/IndexFooter":14,"../public/MainMenu":15,"../public/PopupEmailForm":16,"../public/PopupPolicy":17,"../public/PopupRequestForm":18,"../public/Weborama":23,"./ContentFix":2,"./MinimalClass":10,"./ScrollActionSimple":11,"jquery":28,"smoothscroll-polyfill":29,"webfontloader":30}],2:[function(require,module,exports){
'use strict';
...
},{"class.extend":27,"jquery":28}],3:[function(require,module,exports){
'use strict';
...
},{"./ForceValidable":9,"jquery":28}],4:[function(require,module,exports){
'use strict';
...
},{"./ForceValidable":9,"jquery":28}],5:[function(require,module,exports){
'use strict';
...
},{"./ForceCheckbox":3,"./ForceField":4,"./ForceRadio":7,"./ForceSelect":8,"./MinimalClass":10,"jquery":28}],6:[function(require,module,exports){
'use strict';
...
},{"./MinimalClass":10,"jquery":28}],7:[function(require,module,exports){
'use strict';
...
},{"./ForceValidable":9,"jquery":28}],8:[function(require,module,exports){
'use strict';
...
},{"./ForceValidable":9,"jquery":28}],9:[function(require,module,exports){
'use strict';
...
},{"./MinimalClass":10,"jquery":28}],10:[function(require,module,exports){
'use strict';
...
},{"bezier-easing":26,"class.extend":27,"jquery":28}],11:[function(require,module,exports){
'use strict';
...
},{"./MinimalClass":10,"jquery":28}],12:[function(require,module,exports){
'use strict';
...
},{"./BarkliLoader":13,"./PxLine":19,"jquery":28}],13:[function(require,module,exports){
'use strict';
...
},{"../lib/ForceLoader":6,"./PxLine":19,"jquery":28}],14:[function(require,module,exports){
'use strict';
...
},{"../lib/MinimalClass":10,"jquery":28}],15:[function(require,module,exports){
'use strict';
...
},{"../lib/MinimalClass":10,"./SearchBox":21,"jquery":28}],16:[function(require,module,exports){
'use strict';
...
},{"./RequestForm":20,"jquery":28}],17:[function(require,module,exports){
'use strict';
...
},{"./RequestForm":20,"jquery":28}],18:[function(require,module,exports){
'use strict';
...
},{"./RequestForm":20,"jquery":28}],19:[function(require,module,exports){
'use strict';
...
},{"../lib/MinimalClass":10,"jquery":28}],20:[function(require,module,exports){
'use strict';
...
},{"../lib/ForceForm":5,"./SuperSubmitButton":22,"jquery":28}],21:[function(require,module,exports){
'use strict';
...
},{"../lib/MinimalClass":10,"jquery":28}],22:[function(require,module,exports){
'use strict';
...
},{"../lib/MinimalClass":10,"jquery":28}],23:[function(require,module,exports){
'use strict';
...
},{"class.extend":27,"jquery":28}],24:[function(require,module,exports){
'use strict';

var MobileChoose = require('./mobileChoose'),
    App = require('../lib/App'),
    RequestForm = require('./RequestForm');
...
$(function () {
	...
	$('.menu-trigger').click(function () {
		if ($(this).hasClass('menu-open')) {
			...
			$('.request-popup').fadeOut('fast');
			$('.email-popup').fadeOut('fast');
	...
	$('.form-trigger').click(function () {
		var flat_id = parseInt($(this).attr('data-flat-id') || 0);
		window.request_forms.forEach(function (elm) {
			elm.flat_id = flat_id;
		});

		$('.menu-trigger').addClass('menu-open');
		$('.request-popup').fadeIn('fast');
		$('.content-wrapper').fadeOut('fast');
		$('footer').fadeOut('fast');
	...
	$('.down-btn').click(function () {
		$('body,html').animate({ 'scrollTop': 704 });
	});

	$('.popup-agree').click(function () {
		if ($(this).hasClass('request-agree')) {
			$('.request-popup').fadeOut('fast');
			$('.policy-popup').fadeIn('fast').addClass('request-policy');
			$('header').hide();
			$(window).scrollTop(0);
		} else {
			$('.email-popup').fadeOut('fast').addClass('email-policy');
			$('.policy-popup').fadeIn('fast');
			$('header').hide();
			$(window).scrollTop(0);
		}
	});

	$('.policy-popup .close').click(function () {
		if ($(this).parent().hasClass('request-policy')) {
			$('.request-popup').fadeIn('fast');
			$('.policy-popup').fadeOut('fast').removeClass('request-policy');
		} else if ($(this).parent().hasClass('contacts-policy')) {
			$('.policy-popup').fadeOut('fast').removeClass('contacts-policy');
			$('.content-wrapper').fadeIn('fast');
			$('footer').fadeIn('fast');
			$(window).scrollTop(scrollT);
		} else {
			$('.email-popup').fadeIn('fast');
			$('.policy-popup').fadeOut('fast').removeClass('email-policy');
		}
		$('header').show();
	});

	$('.policy-popup .button-accept').click(function () {
		if ($(this).parent().parent().parent().hasClass('request-policy')) {
			$('.request-popup').fadeIn('fast');
			$('.policy-popup').fadeOut('fast').removeClass('request-policy');
			if (!$('.request-popup .agree input').is(':checked')) {
				$('.request-popup .agree input').trigger('click');
			}
			$('header').show();
		} else if ($(this).parent().parent().parent().hasClass('contacts-policy')) {
			$('.policy-popup').fadeOut('fast').removeClass('contacts-policy');
			if (!$('#contacts-form .agree input').is(':checked')) {
				$('#contacts-form .agree input').trigger('click');
			}
			$('.content-wrapper').fadeIn('fast');
			$('footer').fadeIn('fast');
			$(window).scrollTop(scrollT);
			...
			$('.email-popup').fadeIn('fast');
			$('.policy-popup').fadeOut('fast').removeClass('email-policy');
			if (!$('.email-popup .agree input').is(':checked')) {
				$('.email-popup .agree input').trigger('click');
			}
			$('header').show();
		}
	});

	$('.contacts-agree').click(function () {
		$('.policy-popup').fadeIn('fast').addClass('contacts-policy');
		$('.content-wrapper').fadeOut('fast');
		$('footer').fadeOut('fast');
		scrollT = $(window).scrollTop();
		$('header').hide();
	...
	$('.slick-dots li').each(function () {
		$(this).append('<div class="circle-wrapper" data-anim="base wrapper"><div class="circle" data-anim="base left"></div><div class="circle" data-anim="base right"></div></div><div class="grey-circle"></div>');
	});

	if ($('.month').length > 0) {
		$('.years li:first-child').addClass('active');
		$('.month:first-child').addClass('active');
	}

	$('.years li').click(function () {

		var thisYear = $(this);
		var thisMonth = thisYear.parent().parent().find('.month:first-child');

		$('.year-switcher .active').removeClass('active');
		thisYear.addClass('active');
		thisMonth.addClass('active');

		$.ajax({
			url: thisMonth.data('name'),
			method: "POST",
			dataType: "json",
			async: true,
			success: function (data) {
				$('.process-content').empty().html(data);
				openSlider();
			}
		});
	});
	...
	$('.month').click(function () {
		...
		var thisMonth = $(this);
		var thisYear = thisMonth.parent().parent().find('.' + thisMonth.data('year'));
	...
	function openSlider() {
		...
		$('.photos li').click(function () {
			...
			$.ajax({
				url: $('.month.active').data('slider'),
				method: "POST",
				dataType: "json",
				async: true,
				success: function (data) {

					$('.slider-popup').empty().html(data);

					$('.slider .stage .item').each(function () {
					...
					$('.item-count .now-item').empty().append(index + 1);
					$('.item-count .all-item').empty().append($('.slider .stage .item').length);

					$('.slider-popup').fadeIn('fast');
					$('.content-wrapper').fadeOut('fast');
	...
	function closeSlider() {
		$('.slider-popup .js-close').click(function () {
			$('.slider-popup').fadeOut('fast');
			$('.content-wrapper').fadeIn('fast');
		});
	}

	function sliderCount() {
		$('.slider .stage').on('afterChange', function (event, slick, currentSlide, nextSlide) {
			$('.item-count .now-item').empty().append(currentSlide + 1);
		});
	}
	...
	$('.switcher div').click(function () {
		if ($(this).hasClass('active')) {
			...
			$('.sliders .active').css('display', 'none').removeClass('active');
			$('.slider-' + $(this).data('slider')).css('display', 'block').addClass('active').slick('slickGoTo', 0);
		}
	});

	$('.switcher2 div').click(function () {
		if ($(this).hasClass('active')) {
			return;
		} else {
			$('.switcher2 .active').removeClass('active');
			$(this).addClass('active');
			$('.sliders2 .active').css('display', 'none').removeClass('active');
			$('.slider-' + $(this).data('slider')).css('display', 'block').addClass('active').slick('slickGoTo', 0);
		}
	});
	...
	window.request_forms = [];
	$('.js-popup-request-form').each(function (i, elm) {
		window.request_forms.push(new RequestForm({ element: elm }));
	});

	$('.request-popup').height($(window).height() - 56);
	$('.email-popup').height($(window).height() - 56);

	$('.js-video-trigger').click(function () {
		scrollT = $(window).scrollTop();
		$('.vimeo-box').fadeIn('fast');
		$('.content-wrapper').fadeOut('fast');
		$('header').hide();
		$('.vimeo-box .vimeo-wrap').empty().append('<iframe id="player1" src="https://player.vimeo.com/video/' + $(this).data('vimeo') + '?player_id=player1&title=0&byline=0&portrait=0" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');
	});

	$('.vimeo-box .close').click(function () {
		$('.vimeo-box').fadeOut('fast');
		$('.content-wrapper').fadeIn('fast');
		$('header').show();
		$('.vimeo-box .vimeo-wrap').empty();
		$(window).scrollTop(scrollT);
	});
});
...
},{"../lib/App":1,"./RequestForm":20,"./mobileChoose":25}],25:[function(require,module,exports){
'use strict';
...
module.exports = function () {
    ...
    function __filter() {
        var $_filters = $('.params .checkboxes input:checked');
        var $_multiple = $('.params .bedroom input:checked');

        var $_filters_class = [];
        var $_multiple_class = [];

        $.each($_filters, function (index, filter) {
            $_filters_class.push($(filter).attr('id'));
        });

        $.each($_multiple, function (index, filter) {
            $_multiple_class.push($(filter).attr('id'));
        });

        if ($_filters_class.length || $_multiple_class.length) {
            __hide_all();

            var flats = $('.flats a' + ($_filters_class.length ? '.' + $_filters_class.join('.') : ''));

            if ($_multiple_class.length) {
                flats.each(function (i, flat) {
                    for (var i = 0; i < $_multiple_class.length; i++) {
                        if ($(flat).hasClass($_multiple_class[i])) {
                            $(flat).show();
                            break;
                        }
                    }
